...
export default function Footer() {
  return (
    <footer className="bg-[#006E29] text-white py-16 font-[Outfit] mt-5">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">

        {/* Company Info */}
        <div>
          <h4 className="text-lg font-semibold text-yellow-400 mb-4">Company</h4>
          <p className="text-gray-300 text-sm leading-relaxed">4110 Tench Rd, Suite H</p>
          <p className="text-gray-300 text-sm leading-relaxed">Suwanee, GA 30024</p>

          <div className="mt-4 text-gray-300 text-sm leading-relaxed">
            <p>877-454-7031</p>
            <p className="mt-2 font-medium">Pick-up Hours</p>
            <p>8 AM - 4:30 PM</p>
          </div>
        </div>
        ...
        {/* Shop Links */}
        <div>
          <h4 className="text-lg font-semibold text-yellow-400 mb-4">Shop</h4>
        ...
        {/* Information */}
        <div>
          <h4 className="text-lg font-semibold text-yellow-400 mb-4">Information</h4>
          <ul className="space-y-2 text-gray-300 text-sm">
        ...
        {/* Newsletter */}
        <div>
          <h4 className="text-lg font-semibold text-yellow-400 mb-4">Stay Connected</h4>
          ...
          <form className="flex flex-col sm:flex-row items-center gap-3">
            ...
            />
            <button className="w-full sm:w-auto px-5 py-2 bg-yellow-400 text-[#0f172a] font-semibold rounded-md hover:bg-yellow-300 transition">
              Subscribe
            </button>
          </form>
        </div>
