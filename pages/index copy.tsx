...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ============================= */}
      <section className="w-full py-20 text-center font-[Outfit] bg-[#0f172a]">
        ...
        <p className="text-2xl md:text-3xl text-white leading-relaxed max-w-3xl mx-auto px-6">
      ...
      {/* ============================= */}
      <section className="py-0  text-white font-[Outfit] bg-[#0f172a] w-full overflow-hidden">
      ...
      {/* ============================= */}
      <section className="py-20  text-white font-[Outfit] bg-[#0f172a]">
      ...
      {/* ============================= */}
      <section className="py-20 bg-[#0f172a] text-white font-[Outfit]">
