    ...
    <>
      ...
      <Navbar />
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#006E29] leading-tight break-words">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-[#006E29]">Why OEM With FNB Tech?</h2>

          <div className="grid md:grid-cols-3 gap-10 mt-14">
            <div className="p-8 bg-gray-50 rounded-2xl shadow hover:shadow-xl transition">
              <h3 className="font-bold text-xl text-[#006E29] mb-3">Premium Sourcing</h3>
              <p className="text-gray-600">Specialty-grade beans dari origin terbaik Indonesia.</p>
            </div>

            <div className="p-8 bg-gray-50 rounded-2xl shadow hover:shadow-xl transition">
              <h3 className="font-bold text-xl text-[#006E29] mb-3">Custom Roasting</h3>
              <p className="text-gray-600">Light, medium, dark — semua disesuaikan untuk brand Anda.</p>
            </div>

            <div className="p-8 bg-gray-50 rounded-2xl shadow hover:shadow-xl transition">
              <h3 className="font-bold text-xl text-[#006E29] mb-3">Flexible MOQ</h3>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-[#006E29]">OEM Process</h2>

          <div className="grid md:grid-cols-3 gap-10 mt-16">
            {[1,2,3,4,5,6].map((step) => (
              <div key={step} className="bg-white p-8 rounded-2xl shadow text-left">
                <h3 className="text-xl font-bold text-[#006E29]">{step}. {[
                    'Brand Consultation',
                    'Choose Origin & Blend',
                    'Sampling & Cupping',
                    'Packaging Design',
    ...
    Consult Now
      ...
      <section id="form" className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-[#006E29] mb-12">OEM Inquiry Form</h2>
