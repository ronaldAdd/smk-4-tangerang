...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ============================= */}
      <section className="w-full py-20 text-center font-[Outfit] bg-[#ffffff] px-6">
        ...
        <p className="text-xl sm:text-2xl md:text-3xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
