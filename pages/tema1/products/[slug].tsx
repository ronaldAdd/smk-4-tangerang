    ...
    <>
      ...
      <section className="pt-24 pb-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="text-3xl font-bold text-black mb-6">${displayPrice}</div>

            {hasVariants && (
              <div className="mb-8">
                <h3 className="font-semibold text-black mb-3">Choose Variant</h3>
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-2xl font-bold w-12 text-center text-black">{quantity}</div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6">Flavor Notes</h2>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6">Brewing Guide</h2>
          <ul className="space-y-3 text-gray-600">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6">Specifications</h2>
          <ul className="space-y-3 text-gray-600">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6">Customer Reviews</h2>
      ...
      <section className="py-20 bg-gray-50 px-6">
        <h2 className="text-3xl font-bold text-center text-black mb-14">Related Products</h2>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
          {(related ?? []).map((item, i) => (
            <div key={i} className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
              ...
              <a href={`/products/${item.slug}`} className="text-green-700 font-semibold">View →</a>
            </div>
          ))}
        </div>
      </section>
