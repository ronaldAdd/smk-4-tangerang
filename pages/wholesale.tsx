    ...
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h3 className="text-3xl font-bold text-[#006E29]">Sourced From the Finest Regions</h3>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h3 className="text-4xl font-bold text-[#006E29]">Varieties & Processing</h3>

          <div className="grid md:grid-cols-3 gap-10 mt-14">
            <div className="p-8 bg-white rounded-2xl shadow hover:shadow-xl transition text-left">
              <h4 className="text-xl font-semibold text-[#006E29] mb-3">Arabica</h4>
            ...
            <div className="p-8 bg-white rounded-2xl shadow hover:shadow-xl transition text-left">
              <h4 className="text-xl font-semibold text-[#006E29] mb-3">Robusta</h4>
              <p className="text-gray-600">Lampung, Temanggung, East Java</p>
              <p className="mt-3 text-sm text-gray-500">Washed / Natural</p>
            </div>

            <div className="p-8 bg-white rounded-2xl shadow hover:shadow-xl transition text-left">
              <h4 className="text-xl font-semibold text-[#006E29] mb-3">Special Process</h4>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h3 className="text-4xl font-bold text-[#006E29]">Quality Standards</h3>
          ...
          <div className="grid md:grid-cols-4 gap-8 mt-14">
            <div className="bg-gray-50 p-6 rounded-xl shadow text-center">
              <h4 className="text-lg font-semibold text-[#006E29]">Moisture</h4>
              <p className="text-sm text-gray-600 mt-2">11% ± 1%</p>
            </div>

            <div className="bg-gray-50 p-6 rounded-xl shadow text-center">
              <h4 className="text-lg font-semibold text-[#006E29]">Defects</h4>
              <p className="text-sm text-gray-600 mt-2">SNI / Export Grade</p>
            </div>

            <div className="bg-gray-50 p-6 rounded-xl shadow text-center">
              <h4 className="text-lg font-semibold text-[#006E29]">Screen Size</h4>
              <p className="text-sm text-gray-600 mt-2">16–18 Premium</p>
            </div>

            <div className="bg-gray-50 p-6 rounded-xl shadow text-center">
              <h4 className="text-lg font-semibold text-[#006E29]">Traceability</h4>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h3 className="text-4xl font-bold text-[#006E29]">Packaging Options</h3>

          <div className="grid md:grid-cols-3 gap-12 mt-16">
            <div className="bg-gray-50 p-8 rounded-2xl shadow text-left">
              <h4 className="text-xl font-semibold text-[#006E29]">60–69 kg Jute Bag</h4>
              <p className="text-gray-600 mt-2">Packaging standar internasional.</p>
            </div>

            <div className="bg-gray-50 p-8 rounded-2xl shadow text-left">
              <h4 className="text-xl font-semibold text-[#006E29]">Vacuum Pack</h4>
              <p className="text-gray-600 mt-2">Untuk premium & competition-grade beans.</p>
            </div>

            <div className="bg-gray-50 p-8 rounded-2xl shadow text-left">
              <h4 className="text-xl font-semibold text-[#006E29]">OEM Packaging</h4>
